...
public class DataSourceConfig {
    ...
    public DataSourceConfig(Path dataSourceConfigPath, String dataSourceName) throws CompliancyToolException {

        if (dataSourceConfigPath == null || StringUtils.isEmpty(dataSourceName)) {
            throw new CompliancyToolException("All values are mandatory. Cannot be null or empty.");
        }
    ...
    public DataSourceConfig(String dataSourceConfigPath, String dataSourceName) throws CompliancyToolException {

        if (StringUtils.isEmpty(dataSourceConfigPath) || StringUtils.isEmpty(dataSourceName)) {
            throw new CompliancyToolException("All vallues are mandatory, Cannot be null or empty.");
        }
